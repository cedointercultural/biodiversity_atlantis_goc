...
# Si el script no está en RStudio, usar ruta relativa
...
execute_biodiversity_queries <- function(config_file, 
  ...
  # Ejecutar todas las consultas usando la función centralizada
...
show_help <- function() {
  ...
  cat("EJEMPLO DE CONFIGURACIÓN (query_config.json):\n")
  cat("  {\n")
  cat("    \"general\": {\n")
  cat("      \"polygon_path\": \"shapefiles/study_zone.gpkg\",\n")
  cat("      \"output_dir\": \"data/query_results\"\n")
  cat("    },\n")
  cat("    \"databases\": {\n")
  cat("      \"gbif\": { \"enabled\": true },\n")
  cat("      \"obis\": { \"enabled\": true }\n")
  cat("    }\n")
  cat("  }\n\n")
